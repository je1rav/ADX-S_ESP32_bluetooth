/*
 * si5351.h - Si5351 library for esp-idf (ESP32)
 *  
 *  A few Modifieations have been done to use with esp-idf (ESP32)
 *  by Hitoshi Kawaji (JE1RAV) <je1rav@gmail.com> on 2023.
